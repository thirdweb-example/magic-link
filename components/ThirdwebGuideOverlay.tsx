  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Magic.Link Connector
        </h1>
        <p>
          Using Magic.Link enables your users to connect their wallets via more
          beginner-friendly platforms. Such as email and social media logins.
        </p>
        ...
        <ul style={{ textAlign: "start" }}>
          <li>
            ...
            >
              <b>Thirdweb React SDK useMagic Hook Docs</b>
            </a>
          </li>
